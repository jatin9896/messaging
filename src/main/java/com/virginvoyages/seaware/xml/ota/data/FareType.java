...
@XmlSeeAlso({
    com.virginvoyages.seaware.xml.ota.data.PTCFareBreakdownType.PassengerFare.class,
    com.virginvoyages.seaware.xml.ota.data.AirItineraryPricingInfoType.ItinTotalFare.class
})
