...
@XmlSeeAlso({
    com.virginvoyages.seaware.xml.ota.data.OTACruiseBookingDocumentRQ.CruiseDocument.class,
    com.virginvoyages.seaware.xml.ota.data.OTACruiseBookingDocumentRS.CruiseDocument.class
})
