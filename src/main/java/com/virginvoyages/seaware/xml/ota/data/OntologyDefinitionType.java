...
@XmlSeeAlso({
    com.virginvoyages.seaware.xml.ota.data.MultiModalOfferType.Ontology.CompatibleWith.class,
    com.virginvoyages.seaware.xml.ota.data.MultiModalOfferType.Ontology.class
})
