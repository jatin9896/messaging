 ...
 *         &lt;element name="TPA_Extensions" type="{http://www.versonix.com/ota}ContactPersonTypeExtensionType" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlSeeAlso({
    com.virginvoyages.seaware.xml.ota.data.CruiseGuestDetailType.ContactInfo.class,
    com.virginvoyages.seaware.xml.ota.data.HotelRoomListType.Guests.Guest.class,
    com.virginvoyages.seaware.xml.ota.data.HotelRoomListType.MasterContact.class,
    com.virginvoyages.seaware.xml.ota.data.RecipientInfosType.RecipientInfo.class
})
public class ContactPersonType {
     ...
     */
    public void setTelephone(List<ContactPersonType.Telephone> telephone) {
    ...
    protected ContactPersonTypeExtensionType tpaExtensions;
     ...
     * @return
     *     possible object is
     *     {@link ContactPersonTypeExtensionType }
     *     
     */
    public ContactPersonTypeExtensionType getTPAExtensions() {
     ...
     *     
     */
    public void setTPAExtensions(ContactPersonTypeExtensionType value) {
