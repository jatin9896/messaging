...
@XmlSeeAlso({
    com.virginvoyages.seaware.xml.ota.data.RateAmountMessageType.Rates.Rate.class,
    com.virginvoyages.seaware.xml.ota.data.InvBlockRoomType.RatePlans.RatePlan.class
})
