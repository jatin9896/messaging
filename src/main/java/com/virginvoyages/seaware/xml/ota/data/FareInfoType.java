...
@XmlSeeAlso({
    com.virginvoyages.seaware.xml.ota.data.PTCFareBreakdownType.FareInfo.class,
    com.virginvoyages.seaware.xml.ota.data.AirItineraryPricingInfoType.FareInfos.FareInfo.class
})
