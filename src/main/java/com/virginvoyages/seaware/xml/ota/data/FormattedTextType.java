...
@XmlSeeAlso({
    com.virginvoyages.seaware.xml.ota.data.VehicleAgeRequirementsType.Age.AgeInfos.AgeInfo.class,
    VendorMessageType.class,
    VehicleLocationInformationType.class,
    com.virginvoyages.seaware.xml.ota.data.VehicleLocationVehiclesType.VehicleInfos.VehicleInfo.class,
    com.virginvoyages.seaware.xml.ota.data.VehicleAdditionalDriverRequirementsType.AddlDriverInfos.AddlDriverInfo.class,
    com.virginvoyages.seaware.xml.ota.data.VehicleLocationAdditionalDetailsType.Shuttle.ShuttleInfos.ShuttleInfo.class
})
