...
@XmlSeeAlso({
    com.virginvoyages.seaware.xml.ota.data.CodeListFeeType.Qualifiers.ChargeUnit.Unit.class,
    com.virginvoyages.seaware.xml.ota.data.CodeListFeeType.Taxes.Qualifiers.ChargeUnit.Unit.class
})
