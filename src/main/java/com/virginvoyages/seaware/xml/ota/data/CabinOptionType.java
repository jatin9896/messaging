...
@XmlSeeAlso({
    com.virginvoyages.seaware.xml.ota.data.SailingCategoryInfoType.SelectedCategory.SelectedCabin.class,
    com.virginvoyages.seaware.xml.ota.data.OTACruiseCabinAvailRS.CabinOptions.CabinOption.class
})
