...
@XmlSeeAlso({
    com.virginvoyages.seaware.xml.ota.data.OTACancelRQ.Verification.class,
    com.virginvoyages.seaware.xml.ota.data.HotelResModifyType.HotelResModify.Verification.class
})
