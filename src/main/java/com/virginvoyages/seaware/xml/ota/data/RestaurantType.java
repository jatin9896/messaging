...
@XmlSeeAlso({
    com.virginvoyages.seaware.xml.ota.data.OTACruiseDiningAvailRS.DiningOptions.DiningOption.DiningRoom.class,
    com.virginvoyages.seaware.xml.ota.data.OTACruiseDiningAvailRQ.DiningRoom.class
})
