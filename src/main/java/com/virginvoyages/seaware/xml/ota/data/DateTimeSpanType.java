...
@XmlSeeAlso({
    com.virginvoyages.seaware.xml.ota.data.OTACruiseSailAvailRQ.SailingDateRange.class,
    com.virginvoyages.seaware.xml.ota.data.ResCommonDetailType.TimeSpan.class
})
