...
@XmlSeeAlso({
    com.virginvoyages.seaware.xml.ota.data.CodeListFeeType.Amount.AlternateCurrency.class,
    com.virginvoyages.seaware.xml.ota.data.CodeListFeeType.Taxes.Amount.AlternateCurrency.class
})
