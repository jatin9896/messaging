...
@XmlSeeAlso({
    com.virginvoyages.seaware.xml.ota.data.AccommodationServiceType.AccommodationDetail.class,
    com.virginvoyages.seaware.xml.ota.data.RailPrefType.AccommodationPref.class
})
