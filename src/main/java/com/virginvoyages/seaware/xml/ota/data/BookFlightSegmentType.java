...
@XmlSeeAlso({
    com.virginvoyages.seaware.xml.ota.data.PTCFareBreakdownType.PricingUnit.FareComponent.FlightLeg.class,
    com.virginvoyages.seaware.xml.ota.data.OriginDestinationOptionType.FlightSegment.class
})
