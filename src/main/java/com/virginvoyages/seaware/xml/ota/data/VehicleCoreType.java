...
@XmlSeeAlso({
    com.virginvoyages.seaware.xml.ota.data.VehicleAgeRequirementsType.Age.Vehicles.Vehicle.class,
    VehiclePrefType.class,
    VehicleType.class,
    com.virginvoyages.seaware.xml.ota.data.VehicleAdditionalDriverRequirementsType.AddlDriverInfos.Vehicles.Vehicle.class
})
