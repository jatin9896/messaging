...
@XmlSeeAlso({
    com.virginvoyages.seaware.xml.ota.data.HotelResModifyType.HotelResModify.class,
    com.virginvoyages.seaware.xml.ota.data.HotelReservationsType.HotelReservation.class
})
