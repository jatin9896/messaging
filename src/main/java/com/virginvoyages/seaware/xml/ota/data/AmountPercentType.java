...
@XmlSeeAlso({
    com.virginvoyages.seaware.xml.ota.data.RequiredPaymentsType.GuaranteePayment.AmountPercent.class,
    com.virginvoyages.seaware.xml.ota.data.RatePlanType.Guarantee.AmountPercent.class
})
