...
@XmlSeeAlso({
    ...
    com.virginvoyages.seaware.xml.ota.data.BaggageQueryType.AirlineCarrier.class,
    com.virginvoyages.seaware.xml.ota.data.AllianceConsortiumType.AllianceMember.class,
    com.virginvoyages.seaware.xml.ota.data.DirectBillType.CompanyName.class,
    com.virginvoyages.seaware.xml.ota.data.VehicleAvailCoreType.Vendor.class,
    CompanyNamePrefType.class,
    TravelArrangerType.class,
    com.virginvoyages.seaware.xml.ota.data.FlightSegmentType.MarketingAirline.class,
    com.virginvoyages.seaware.xml.ota.data.PaymentFormType.Voucher.BillingAccountName.class
})
