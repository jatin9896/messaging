...
@XmlSeeAlso({
    com.virginvoyages.seaware.xml.ota.data.BookingRulesType.BookingRule.AcceptableGuarantees.AcceptableGuarantee.class,
    com.virginvoyages.seaware.xml.ota.data.RatePlanType.Guarantee.class
})
