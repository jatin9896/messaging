    ...
    extends SailingInfoType
{
    ...
    /**
     * @param selectedCategory - selectedCategory
     */
    public void setSelectedCategory(List<SailingCategoryInfoType.SelectedCategory> selectedCategory) {
        this.selectedCategory = selectedCategory;
    }

    @Override
    public String toString() {
        return "SailingCategoryInfoType [selectedCategory=" + selectedCategory + ", information=" + information + "]";
    }
    ...
    public static class SelectedCategory {
        ...
        /**
         * @param selectedCabin - selectedCabin
         */
        public void setSelectedCabin(List<SailingCategoryInfoType.SelectedCategory.SelectedCabin> selectedCabin) {
            this.selectedCabin = selectedCabin;
        }

        @Override
        public String toString() {
            return "SelectedCategory [cabinAttributes=" + cabinAttributes + ", selectedCabin=" + selectedCabin
                    + ", waitlistIndicator=" + waitlistIndicator + ", berthedCategoryCode=" + berthedCategoryCode
                    + ", pricedCategoryCode=" + pricedCategoryCode + ", deckNumber=" + deckNumber + ", deckName="
                    + deckName + ", fareCode=" + fareCode + ", groupCode=" + groupCode + ", groupName=" + groupName
                    + "]";
        }
